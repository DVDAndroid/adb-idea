...
public final class ModuleChooserDialogHelper {
	...
	public static final String SELECTED_MODULE_PROPERTY = ModuleChooserDialogHelper.class
			.getCanonicalName() + "-SELECTED_MODULE";

	private ModuleChooserDialogHelper() {
	}

	public static AndroidFacet showDialogForFacets(Project project,
		...
		ChooseModulesDialog dialog = new ChooseModulesDialog(project, modules,
				"Choose Module", "");
